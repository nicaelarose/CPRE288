...
uint8_t button_getButton() {
    ...
    uint8_t temp = 0;
    if((GPIO_PORTE_DATA_R & 0b00000001) == 0b0) {
            return 1;
    }
    else if((GPIO_PORTE_DATA_R & 0b00000010) == 0b00) {
            return 2;
    }
    else if((GPIO_PORTE_DATA_R & 0b00000100) == 0b000) {
            return 3;
    }
    else if((GPIO_PORTE_DATA_R & 0b00001000) == 0b0000) {
            return 4;
    }
	return temp;
}

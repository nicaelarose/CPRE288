...
uint8_t button_getButton() {
	...
	if ((GPIO_PORTE_DATA_R & 0b00001000) == 0b00000000) //sw04
	{
	    return 4;
	}
	else if ((GPIO_PORTE_DATA_R & 0b00000100) == 0b00000000) //sw03
	{
	    return 3;
	}
	else if ((GPIO_PORTE_DATA_R & 0b00000010) == 0b00000000) //sw02
	{
	    return 2;
	}
	else if ((GPIO_PORTE_DATA_R & 0b00000001) == 0b00000000) //sw01
	{
	    return 1;
	}
	else
